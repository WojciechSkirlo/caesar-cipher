  ...
  <main class="flex items-center justify-center w-full min-h-screen px-4">
    <div class="flex flex-col w-full max-w-2xl">
        ...
        <form @submit.prevent="encrypt" class="flex w-full gap-5 sm:gap-8">
          <div class="flex flex-col flex-1">
            <p class="mb-4 text-xs text-gray-500">
              ...
              a, ą, b, c, ć, d, e, ę, f, g, h, i, j, k, l, ł, m, n, ń, o, ó, p, q, r, s, ś, t, u, v, w, x, y, z, ź, ż (35 chars)
            </p>
      ...
      <span class="mt-2 text-xs text-center text-gray-500">
        <a href="https://woytek-portfolio.netlify.app" class="hover:underline hover:text-[#D8B4FE]" target="_blank">Wojciech Skirło</a> &copy 2022
      </span>
    </div>
  </main>
</template>
